...
description: Questo articolo include materiale sussidiario per professionisti IT su come progettare soluzioni di gestione di dispositivi mobili (MDM) compilate in Enterprise Mobility + Security.
keywords: 
author: andredm7
ms.author: andredm
manager: swadhwa
...
---
# <a name="mobile-device-management-design-considerations-guide"></a>Guida alle considerazioni sulla progettazione per la gestione dei dispositivi mobili
...
![Esempio di una soluzione di gestione di dispositivi mobili ibrida in Intune e System Center Configuration Manager](./media/MDM_Figure_01.png)
**Esempio di una soluzione di gestione di dispositivi mobili ibrida in Intune e System Center Configuration Manager**
...
## <a name="mdm-design-considerations"></a>Considerazioni sulla progettazione MDM
...
- [Passaggio 4: Pianificare la gestione dei dispositivi mobili SaaS (Software as a Service, Software come servizio)](mdm-step-4-plan-for-software-as-a-service-mobile-device-management.md)
...
## <a name="looking-for-a-downloadable-version"></a>Versione scaricabile

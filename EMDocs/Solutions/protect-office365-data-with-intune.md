---
title: Proteggere i dati aziendali di Office 365 con Microsoft Intune | Microsoft Intune
description: 
keywords: 
author: jeffgilb
manager: angrobe
...
ms.sourcegitcommit: 96f2aad2bef974438ecfcf65656be4a5e7f3a656
ms.openlocfilehash: b01d9d0123a3e63d763bc832eed9d7da7de84549


---

# Proteggere i dati aziendali di Office 365 con Intune
...
## Come può essere utile Enterprise Mobility + Security (EMS)?
...
## Registrare dispositivi mobili e PC Windows per la gestione
...
## Proteggere l'accesso ai servizi di Office 365
...
> <sup>1</sup> Solo iOS e Android, <sup>2</sup> Dispositivi iOS, Android e Windows

### Proteggere l'accesso a Exchange Online
...
### Proteggere l'accesso a SharePoint Online
...
### Gestione di applicazioni mobili per dispositivi mobili iOS e Android gestiti
...
### Windows Information Protection (WIP) per PC e dispositivi mobili Windows 10 gestiti
...
## Cancellare i dati aziendali in modo selettivo
...
### Altre informazioni
[Scenari di produttività dei dispositivi mobili gestiti](https://docs.microsoft.com/enterprise-mobility/solutions/managed-mobile-productivity)

...
Vedere le sezioni dell'[Informativa sulla Privacy](http://www.microsoft.com/privacystatement/en-us/core/default.aspx) riguardanti la raccolta e utilizzo delle informazioni personali.

[Inizio pagina](#top)

## Comunicazione specifica relativa al Software disponibile nel presente sito Web
Qualsivoglia software reso disponibile per il download tramite i Servizi ("Software") è opera tutelata da copyright di Microsoft e/o dei suoi fornitori. L'uso del Software è disciplinato dalle eventuali condizioni del contratto di licenza con l'utente finale, fornito insieme al Software o ad esso accluso ("Contratto di Licenza"). Un utente finale non sarà in grado di installare nessun software corredato da o comprensivo di un Contratto di licenza se prima non accetta i termini del Contratto di licenza. Il codice o gli script di terze parti collegati al presente sito o a cui il sito Web fa riferimento vengono ceduti in licenza all'utente dalle terze parti proprietarie di tale codice, non da Microsoft. 

Il Software viene reso disponibile per il download esclusivamente per l'utilizzo da parte degli utenti finali, in base a quanto previsto dal Contratto di licenza. Qualsivoglia riproduzione o ridistribuzione del Software non conforme al Contratto di Licenza è espressamente vietata dalla legge in vigore e potrà comportare gravi sanzioni civili e penali. I trasgressori saranno perseguiti nella misura massima consentita dalla legge applicabile.

SENZA LIMITARE QUANTO SOPRA, LA COPIA O LA RIPRODUZIONE DEL SOFTWARE IN QUALSIASI ALTRO SERVER O POSIZIONE PER L'ULTERIORE RIPRODUZIONE O RIDISTRIBUZIONE È ESPRESSAMENTE VIETATA, SALVO SE TALE RIPRODUZIONE O RIDISTRIBUZIONE È ESPRESSAMENTE CONSENTITA DAL CONTRATTO DI LICENZA CHE ACCOMPAGNA TALE SOFTWARE.

IL SOFTWARE È EVENTUALMENTE COPERTO DA GARANZIA SOLO IN BASE ALLE CONDIZIONI DEL CONTRATTO DI LICENZA. FATTA ECCEZIONE PER QUANTO GARANTITO NEL CONTRATTO DI LICENZA, CON LA PRESENTE MICROSOFT CORPORATION NON RICONOSCE ALCUNA GARANZIA O CONDIZIONE RELATIVAMENTE AL SOFTWARE, INCLUSE TUTTE LE GARANZIE E CONDIZIONI ESPRESSE, IMPLICITE O PRESCRITTE DALLA LEGGE, DI COMMERCIABILITÀ, ADEGUATEZZA PER UNO SCOPO SPECIFICO, TITOLARITÀ E NON VIOLAZIONE DI DIRITTI DI TERZI. PER COMODITÀ, MICROSOFT POTRÀ RENDERE DISPONIBILI COME PARTE DEI SERVIZI O NEI PRODOTTI SOFTWARE STRUMENTI E UTILITÀ PER L'UTILIZZO E/O IL DOWNLOAD. MICROSOFT NON RILASCIA ALCUNA GARANZIA IN RELAZIONE ALL'ACCURATEZZA DEI RISULTATI DERIVANTI DALL'UTILIZZO DI TALI STRUMENTI E UTILITÀ. QUANDO SI UTILIZZANO GLI STRUMENTI E UTILITÀ RESI DISPONIBILI NEI SERVIZI O NEI PRODOTTI SOFTWARE MICROSOFT, SI È TENUTI A RISPETTARE I DIRITTI DI PROPRIETÀ INTELLETTUALE DI TERZI.

LEGENDA PER I DIRITTI LIMITATI. Qualsivoglia Software scaricato dai Servizi a favore o per conto degli Stati Uniti d'America, dei relativi enti o agenzie federali ("Governo degli Stati Uniti") viene fornito con diritti limitati. L'utilizzo, la duplicazione o la divulgazione da parte del Governo degli Stati Uniti è soggetta alle limitazioni stabilite nel sottoparagrafo (c)(1)(ii) della clausola The Rights in Technical Data and Computer Software del DFARS 252.227-7013 o nei sottoparagrafi (c)(1) e (2) della clausola Commercial Computer Software - Restricted Rights in 48 CFR 52.227-19, a seconda dei casi. Il produttore è Microsoft Corporation, One Microsoft Way, Redmond, WA 98052-6399.

[Inizio pagina](#top)

## Comunicazione specifica relativa ai documenti disponibili nel presente sito Web
...
## Comunicazioni riguardanti Software, Documenti e Servizi disponibili nel presente sito Web
...
## Account membro, password e protezione
...
## Divieto di utilizzo illecito o vietato
...
Microsoft non è tenuta a monitorare i Servizi di comunicazione. Tuttavia, Microsoft si riserva il diritto di esaminare i materiali pubblicati o trasmessi tramite i Servizi di comunicazione e di rimuoverli a sua esclusiva discrezione. Microsoft si riserva il diritto di negare ai clienti l'accesso a uno o a tutti i Servizi di comunicazione in qualsiasi momento, senza preavviso e per qualunque motivo.
...
## Materiali forniti a Microsoft o inviati a qualsiasi sito Web Microsoft
...
## Criteri per l'invio di idee non richieste

...
|Etichette di Office 365|Internal Public|Private|Dati sensibili|Highly Confidential (Riservatezza elevata)|
...
Per la procedura di distribuzione dei quattro tipi diversi di siti del team di SharePoint Online in questa soluzione, vedere [Distribuire siti per tre livelli di protezione](deploy-sites-for-three-tiers-of-protection.md).
